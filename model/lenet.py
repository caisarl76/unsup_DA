...
class DSBNLeNet(nn.Module):
    ...
    def printnorm(self, input, output, unknown1):
        # print(output)
        print(output[0].shape)
        output_mean = output[0].data.mean(dim=1)
        output_dev = output[0].data.std(dim=1)
        # print(output_mean.shape, output_dev.shape)
        # print('output mean: %0.3f, dev: %0.3f'%(output_mean, output_dev))
        # return output_norm
